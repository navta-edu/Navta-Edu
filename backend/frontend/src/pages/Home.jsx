  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-transparent pb-20">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-[8%] top-16 h-72 w-72 rounded-full bg-sky-400/15 blur-[110px]" />
        <div className="absolute right-[6%] top-[28rem] h-96 w-96 rounded-full bg-violet-500/10 blur-[140px]" />
        <div className="absolute bottom-10 left-1/3 h-80 w-80 rounded-full bg-cyan-400/10 blur-[130px]" />
      </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-10 sm:px-6 sm:pt-14 lg:px-8 lg:pt-16">
        <div className="relative overflow-hidden rounded-[30px] border border-white/50 bg-white/78 shadow-[0_30px_100px_rgba(15,23,42,0.16)] backdrop-blur-2xl dark:border-slate-700/50 dark:bg-slate-950/78">
          <div className="absolute inset-0 bg-gradient-to-br from-white/60 via-transparent to-sky-100/30 dark:from-slate-900/50 dark:to-indigo-950/20" />
          ...
          <div className="relative grid gap-10 px-6 py-8 sm:px-8 sm:py-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-12 lg:py-14">
            <div>
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-sky-200/70 bg-sky-50/90 px-3.5 py-2 text-xs font-extrabold text-sky-700 shadow-sm dark:border-sky-800/50 dark:bg-sky-950/40 dark:text-sky-300">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                {user ? (
                  <Link to={dashboardPath} className="w-full sm:w-auto">
                    <Button icon={ArrowRight} className="w-full justify-center sm:w-auto">
                      Open My Dashboard
                    </Button>
                  </Link>
                ) : (
                  <>
                    ...
                    <Link to="/navta-test" className="w-full sm:w-auto">
            ...
            <div className="relative">
              ...
              <div className="rounded-[26px] border border-slate-200/80 bg-slate-950 p-4 shadow-2xl dark:border-slate-700">
                ...
                <div className="mt-3 rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <p className="text-xs font-bold text-slate-400">NAVTA TEST</p>
                    ...
                    <div className="rounded-xl bg-emerald-500/10 px-3 py-2 text-right">
                      <p className="text-[10px] font-bold uppercase text-emerald-400">Ready</p>
                      <p className="text-sm font-black text-white">30 Q</p>
                    </div>
                  </div>
                ...
                <div className="mt-3 grid grid-cols-2 gap-3">
                  <PreviewTile icon={BookOpen} title="Study Notes" value="14 chapters" />
                  <PreviewTile icon={BrainCircuit} title="AI Feedback" value="Actionable" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto mt-7 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-3 rounded-[26px] border border-white/50 bg-white/72 p-3 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl md:grid-cols-4 dark:border-slate-800/50 dark:bg-slate-950/60">
          {stats.map((stat) => (
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <article
                key={feature.title}
                className="group relative overflow-hidden rounded-[24px] border border-white/60 bg-white/78 p-6 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_26px_80px_rgba(15,23,42,0.14)] dark:border-slate-800/60 dark:bg-slate-950/65"
              >
                <div className={`absolute inset-x-0 top-0 h-28 bg-gradient-to-b ${feature.accent} opacity-80`} />

                <div className="relative">
                  <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl border border-white/60 bg-white/80 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      ...
      ===================================================== */}
      <section className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-[30px] border border-slate-800 bg-slate-950 shadow-[0_30px_100px_rgba(2,6,23,0.30)]">
          <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[0.9fr_1.1fr] lg:p-12">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full bg-sky-500/10 px-3 py-2 text-xs font-extrabold text-sky-400">
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-slate-400 sm:text-base">
                Select subject, preparation, class, chapter and difficulty. NAVTA then builds a
                focused test with timing logic matched to the exam mode.
              </p>

              <div className="mt-7 space-y-3">
                <SpotlightRow icon={Clock3} text="NEET • 1 minute per MCQ" />
                <SpotlightRow icon={Clock3} text="JEE • 2 minutes per MCQ" />
                <SpotlightRow icon={BrainCircuit} text="Boards • MCQ, Short Answer and Long Answer with AI feedback" />
              </div>

              <Link to="/navta-test" className="mt-8 inline-block">
                <Button icon={ArrowRight}>Open NAVTA TEST</Button>
              </Link>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3 lg:self-center">
              <ModeCard
                ...
                icon="🩺"
                bullets={['MCQ', 'Easy / Medium / Hard', 'Chapter-wise']}
              />
              ...
              <ModeCard
                ...
                icon="🚀"
                bullets={['MCQ', 'Timed practice', 'Chapter-wise']}
              />
              ...
              <ModeCard
                ...
                detail="AI-assisted"
                icon="📚"
                bullets={['MCQ', 'Short answer', 'Long answer']}
              />
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-6">
          {journey.map((item, index) => (
            <div
              key={item.step}
              className="relative rounded-[22px] border border-white/60 bg-white/76 p-5 text-center shadow-[0_14px_45px_rgba(15,23,42,0.07)] backdrop-blur-xl dark:border-slate-800/50 dark:bg-slate-950/60"
            >
              <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-slate-950 text-xs font-black text-white dark:bg-sky-500">
                {item.step}
              </div>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[28px] border border-white/60 bg-white/78 p-7 shadow-[0_20px_70px_rgba(15,23,42,0.09)] backdrop-blur-xl dark:border-slate-800/50 dark:bg-slate-950/65 sm:p-8">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-400">
              Upload study material, build question banks, manage NAVTA TEST content and track
              student performance from one administrative workflow.
            </p>

            <Link to="/signup" state={{ role: 'teacher' }} className="mt-6 inline-block">
              <Button variant="secondary">Join as an Educator</Button>
            </Link>
          </div>

          <div className="relative overflow-hidden rounded-[28px] border border-sky-400/20 bg-gradient-to-br from-slate-950 via-[#07182b] to-[#102a43] p-7 shadow-[0_24px_90px_rgba(2,132,199,0.18)] sm:p-8">
            <div className="absolute right-0 top-0 h-56 w-56 rounded-full bg-sky-500/20 blur-[90px]" />
            <div className="absolute bottom-0 left-1/3 h-48 w-48 rounded-full bg-violet-500/20 blur-[90px]" />

            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-2 text-xs font-bold text-sky-300">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                Learn, practise, test, analyse and improve — without switching between five different platforms.
              </p>

              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Link to={user ? dashboardPath : '/signup'} className="w-full sm:w-auto">
                  <Button icon={ArrowRight} className="w-full justify-center sm:w-auto">
...
function PreviewTile({ icon: Icon, title, value }) {
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-3">
...
function SpotlightRow({ icon: Icon, text }) {
  return (
    <div className="flex items-start gap-3 rounded-2xl border border-slate-800 bg-white/[0.03] p-3">
      <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-sky-500/10">
        <Icon className="h-4 w-4 text-sky-400" />
      </div>
...
function ModeCard({ title, subtitle, detail, icon, bullets }) {
  return (
    <div className="rounded-[24px] border border-slate-800 bg-slate-900/75 p-5">
      ...
      <p className="mt-2 text-sm font-extrabold text-sky-400">{detail}</p>
