    ...
    <>
      <style>{`
        * {
        ...
        /* =====================================================
           NAVTA LIGHT MODE FIX
           Fixes saved-question options and all dark-only text
           while leaving the existing dark mode untouched.
        ===================================================== */
        ...
        html:not(.dark):not([data-theme="dark"]) .admin-navta-review-text,
        html:not(.dark):not([data-theme="dark"]) .admin-navta-drop-question,
        ...
        /* IMPORTANT: this is the class used by the saved question options. */
        html:not(.dark):not([data-theme="dark"]) .admin-navta-bank-options {
          color: #334155;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-bank-options li {
          color: #334155;
          font-weight: 500;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-bank-options li::marker {
          color: #475569;
          font-weight: 700;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-bank-pill {
          background: #ffffff;
          border-color: #94a3b8;
          color: #64748b;
        }
        ...
        html:not(.dark):not([data-theme="dark"]) .admin-navta-textarea:disabled {
          background: #f1f5f9;
          color: #64748b;
          opacity: 1;
        }
        ...
        html:not(.dark):not([data-theme="dark"]) .admin-navta-empty-state {
          background: #f8fafc;
          border-color: #dbe3ef;
          color: #64748b;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-question-preview-image-shell,
        html:not(.dark):not([data-theme="dark"]) .admin-navta-crop-stage {
          background: #ffffff;
          border-color: #dbe3ef;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-bank-clear,
        ...
        html:not(.dark):not([data-theme="dark"]) .admin-navta-bank-clear:hover,
        ...
        html:not(.dark):not([data-theme="dark"]) .admin-navta-drop-card {
          background: #fff7f7;
          border-color: #fecaca;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-drop-reason {
          color: #b91c1c;
        }

        html:not(.dark):not([data-theme="dark"]) .admin-navta-math-fallback {
          color: #92400e;
        }
